    ...
    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
        <div class="item" data-id="<?=$row->id?>" data-action="<?=cn("disconnect")?>">
            ...
            <div class="checkpoint bg-orange text-center">
                ...
                <?=l("Please go to <a href='http://instagram.com/' target='_blank'>http://instagram.com/</a> to verify email and then login at here again");?>
            </div>
            <?php }?>
                ...
                <div class="list-group-item control">
                    ...
                    <div class="btn-group" style="width: 28%;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="javascript:void(0);" class=" waves-effect waves-block btnReconnect btnUpdateGroups" data-type="page" data-id="<?=$row->account_id?>" data-action-groups="<?=url('instagram_accounts/ajax_get_groups')?>"><?=l('Reconect')?></a></li>
