                            ...
                            <form name="config-form" id="config-form" action="do_install.php" method="post">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group clearfix">
                                            <label for="fullname" class=" col-md-3">Google API Key (<a href="https://youtu.be/zWoS6CC9rjo" target="_blank">Video guide</a>)</label>
                                            <div class="col-md-9">
                                                <input type="text" value=""  id="google_api_key"  name="google_api_key" class="form-control"  placeholder="Google API Key" />
